...
ActiveRecord::Schema[8.1].define(version: 2026_07_12_194034) do
  ...
  create_table "activity_events", force: :cascade do |t|
    ...
    t.index ["user_id", "id"], name: "index_activity_events_on_user_id_and_id_desc", order: { id: :desc }
  ...
  create_table "export_runs", force: :cascade do |t|
    ...
    t.index ["user_id", "created_at"], name: "index_export_runs_on_user_id_and_created_at"
    t.index ["user_id", "status"], name: "index_export_runs_on_user_id_and_status"
  ...
  create_table "import_runs", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.bigint "user_id", null: false
    t.index ["user_id", "created_at"], name: "index_import_runs_on_user_id_and_created_at"
    t.index ["user_id", "status"], name: "index_import_runs_on_user_id_and_status"
